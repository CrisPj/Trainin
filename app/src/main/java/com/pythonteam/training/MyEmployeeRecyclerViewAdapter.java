...
import com.pythonteam.training.EmployeesFragment.OnListFragmentInteractionListener;
...
public class MyEmployeeRecyclerViewAdapter extends RecyclerView.Adapter<MyEmployeeRecyclerViewAdapter.ViewHolder> {
    ...
    public MyEmployeeRecyclerViewAdapter(List<Employee> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        String a = String.valueOf(mValues.get(position).getKeyEmployee());
        holder.mIdView.setText(a);
        holder.mContentView.setText(mValues.get(position).getNameEmp());
